...
export default function Projects(){
    return (
        <div style={{ width:'100vw', height:'150vh', backgroundColor:'#ecebf3', marginTop:'5vh', display:'flex',flexDirection:'column',alignItems:'center'}}>
            <h1 style={{ paddingTop:'15vh', color:'#c20114', textDecoration:'underline', fontFamily:'monospace', textShadow:'2px 2px black', textDecorationWidth:'4px', textDecorationColor:'#c20114', paddingBottom:'10vh'}}>Projects/Work</h1>
